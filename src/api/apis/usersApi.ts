...
import { ForgotPasswordRequestDto, ForgotPasswordResetDto, ForgotPasswordVerifyCodeDto, LoginRequestDto, RefreshTokenRequestDto, TokenResponseDto, UpdateMePasswordRequestDto, UserResponseDto, UserRoleEnum, UsersApiApiUsersForgotPasswordRequestPostRequest, UsersApiApiUsersForgotPasswordResetPasswordPostRequest, UsersApiApiUsersForgotPasswordVerifyCodePostRequest, UsersApiApiUsersIdGetRequest, UsersApiApiUsersMeChangePasswordPutRequest, UsersApiApiUsersMePutRequest } from '../api';
...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiUsersForgotPasswordRequestPost: async (forgotPasswordRequestDto?: ForgotPasswordRequestDto, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/user/forgot-password/request`;
        ...
        apiUsersForgotPasswordResetPasswordPost: async (forgotPasswordResetDto?: ForgotPasswordResetDto, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/user/forgot-password/reset-password`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        apiUsersForgotPasswordVerifyCodePost: async (forgotPasswordVerifyCodeDto?: ForgotPasswordVerifyCodeDto, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/user/forgot-password/verify-code`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
